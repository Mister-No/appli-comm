  ...
  public function preview()
  {
    if ($_SESSION["is_connect"] == TRUE){
      ...
      foreach ($result_newsletter as $row_newsletter) {
        ...
        $text0 = nl2br($this->My_campagnes->replace_one_pattern(urldecode($row_newsletter->newsletter_block_text0)));
        $text1 = nl2br($this->My_campagnes->replace_one_pattern(urldecode($row_newsletter->newsletter_block_text1)));
        $text2 = nl2br($this->My_campagnes->replace_one_pattern(urldecode($row_newsletter->newsletter_block_text2)));
        $text3 = nl2br($this->My_campagnes->replace_one_pattern(urldecode($row_newsletter->newsletter_block_text3)));
        $text4 = nl2br($this->My_campagnes->replace_one_pattern(urldecode(urlencode($row_newsletter->newsletter_block_text4))));
        $text5 = nl2br($this->My_campagnes->replace_one_pattern(urldecode($row_newsletter->newsletter_block_text5)));
        $text6 = nl2br($this->My_campagnes->replace_one_pattern(urldecode($row_newsletter->newsletter_block_text6)));
      ...
      $search = '/<button class="display.*?<\/button>/is';
      $replace = '';
      $newsletter = preg_replace($search,$replace,$newsletter);
      //$search = '/§§§§/';
      //$replace = '"';
