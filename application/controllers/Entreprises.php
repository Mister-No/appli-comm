  ...
  public function add()
	{
      ...
      $result = $this->My_entreprises->check_exist($this->input->post('raison_sociale'), $id_group);
	...
	public function update()
	{
      ...
      $result = $this->My_entreprises->check_exist($this->input->post('raison_sociale'), $id_group, $this->input->post('id'));
