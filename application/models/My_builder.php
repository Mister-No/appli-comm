...
class My_builder extends CI_Model {
  ...
  /************************************************/
	...
	/******************************************************/
	function get_block_by_id($id_newsletter, $id_block, $id_block_content, $id_block_html, $id_group){
		...
		$this->db->where("newsletter.id", $id_newsletter);
		$this->db->where("newsletter.id_group", $id_group);
		$this->db->where("newsletter_has_block.id", $id_block);
		$this->db->where("newsletter_block_html.id", $id_block_html);
