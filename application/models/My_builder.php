...
class My_builder extends CI_Model {
	...
	/********************************************************/
	/*         SELECT NEWSLETTER THEMES			                */
	/********************************************************/
	function get_newsletter_themes($id_group){
